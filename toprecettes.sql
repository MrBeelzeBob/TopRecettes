...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 13 Mai 2015 à 16:28
...
INSERT DELAYED INTO `tcomments` (`idComment`, `CommentText`, `CommentNote`, `CommentDate`, `idUser`, `idRecipe`) VALUES
...
INSERT DELAYED INTO `tcontains` (`idContains`, `ContainsQuantity`, `idRecipe`, `idIngredient`) VALUES
...
(109, '250 g', 11, 311),
(110, '1 pincée', 11, 312),
(111, 'asasasasassasasasasasasasasa', 30, 314);
...
INSERT DELAYED INTO `tingredients` (`idIngredient`, `IngredientName`) VALUES
(1, 'ABRICOT'),
(2, 'AGNEAU'),
(3, 'AIL'),
(4, 'AIRELLE'),
...
INSERT DELAYED INTO `trecipes` (`idRecipe`, `RecipeTitle`, `RecipePreparation`, `RecipeOrigin`, `idType`, `RecipeImage`, `idUser`, `RecipeDate`) VALUES
...
(30, 'asasas', 'ad asd ad', 'asasa', 2, './imgRecettes/toprecette.jpg', 1, '2015-05-13');
...
INSERT DELAYED INTO `ttypes` (`idType`, `TypeName`) VALUES
(4, 'Accompagnement'),
(5, 'Amuse-gueule'),
(6, 'Boisson'),
(7, 'Confiserie'),
...
INSERT DELAYED INTO `tusers` (`idUser`, `UserPseudo`, `UserPassword`, `UserEmail`, `UserAdmin`) VALUES
